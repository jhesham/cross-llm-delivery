...
description: >-
  ...
  executor LLM (antigravity:Gemini 3.1 Pro (High)) while Claude acts as architect and
...
- **Default = the proven $0 flat-rate or low-cost workhorse** (`antigravity:Gemini 3.1 Pro (High)`). Enter selects it.
...
**Usage view:** run `run_delivery.py <plan> --usage` (or the `cross-llm-antigravity-usage`
