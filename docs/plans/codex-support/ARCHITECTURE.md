...
See [T06 integration guide](T06-INTEGRATION.md) for the implemented selector, immutable ref, journal, retry and manual-resolution contracts. T06 keeps successful integration worktrees as well as failure evidence; T07 implements the exit/gate table below; versioned JSON remains T11 work.
...
**T07 implementation:** [The CLI/API contract](T07-CONTRACT.md) records validated plan syntax, structured TestRun results, explicit legacy adapters, verified retained-worktree repair and gates 0/2/3/4/5/6. Operation telemetry and recorded status share these outcomes. M2 evidence is in [T07-EVIDENCE.md](T07-EVIDENCE.md).
