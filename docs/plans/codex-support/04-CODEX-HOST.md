...
- [x] Test sandbox denial: report the needed capability without silently broadening permissions. Verify a worktree root can be configured inside the allowed workspace.
