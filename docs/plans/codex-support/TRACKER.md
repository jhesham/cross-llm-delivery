...
Status: T01 through T17 and M1–M4 plus optional M6 complete. T18 is the next required task. Stop for the user token-availability checkpoint before starting it.
