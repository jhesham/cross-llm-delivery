...
description: >-
  ...
  executor LLM ({{DEFAULT_WORKHORSE}}) while Claude acts as architect and
...
- **Default = the proven $0 flat-rate or low-cost workhorse** (`{{DEFAULT_WORKHORSE}}`). Enter selects it.
